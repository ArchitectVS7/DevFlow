/**
 * SessionManager - Manages conversational sessions for devflow start/summarize
 *
 * This class handles:
 ...
 *
 * Sessions are stored in `.devflow/sessions/` as JSON files:
 * `.devflow/sessions/{session-id}.json`
 */
...
export class SessionManager {
  ...
  private readonly defaultSessionsDir = '.devflow/sessions';
