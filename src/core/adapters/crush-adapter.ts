...
/**
 * Crush CLI adapter
 * Commands stored in .crush/commands/devflow/ (supports subdirectories)
...
export class CrushAdapter extends BaseAdapter {
  ...
  readonly directory = '.crush/commands/devflow';
  ...
  protected formatCommand(template: CommandTemplate): string {
    // Replace DevFlow generic placeholder with Crush placeholder
