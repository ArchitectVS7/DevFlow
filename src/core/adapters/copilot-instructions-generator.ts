...
export class CopilotInstructionsGenerator {
  ...
  /**
   * Generate or update .github/copilot-instructions.md with DevFlow workflows
   */
  ...
  /**
   * Check if .github/copilot-instructions.md has DevFlow block
   */
  static async hasDevFlowBlock(): Promise<boolean> {
