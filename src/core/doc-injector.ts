...
- \`/devflow:prd\` - Generate a PRD through guided questions
- \`/devflow:start\` - Start conversational mode for iterative refinement
- \`/devflow:summarize\` - Extract optimized prompt from conversation
